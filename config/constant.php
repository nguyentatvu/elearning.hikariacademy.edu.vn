...
return [
    ...
    'banner' => [
        ...
        2 => [
            ...
            'title' => 'Slider Trượt Trang Chủ',
            'description' => 'Một slider chứa nhiều hình ảnh được giới thiệu trên trang chủ.',
            'size' => '1920x600',
        ...
        10 => [
            ...
            'category' => 'single_image',
            'title' => 'Logo Khóa Học',
            'description' => 'Logo này được sử dụng trên các trang liên quan đến khóa học để nhận diện và thương hiệu.',
            'size' => '300x100',
