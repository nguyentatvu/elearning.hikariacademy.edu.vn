!(function () {
  ...
  async function e() {
    if (p && p.token) {
      ...
      const i =
        `${p.baseUrl || `https://${p.isDev ? "dev." : ""}udify.app`}/chatbot/${
          p.token
        }?` + e;
      function o() {
        var e, t;
        window.innerWidth <= 640 ||
          ...
          e &&
            ...
            ((t = t.getBoundingClientRect()).top - 5 > e.clientHeight
              ? ((e.style.bottom = t.height + 5 + "px"),
                (e.style.top = "unset"))
              : ((e.style.bottom = "unset"),
                (e.style.top = t.height + 5 + "px")),
            ...
            document.addEventListener("mousemove", function (e) {
              ...
              i &&
                ...
                ("x" !== l && "both" !== l) ||
                  s.style.setProperty(
                    `--${a}-left`,
                    Math.max(0, Math.min(t, n)) + "px"
                  ),
                ("y" !== l && "both" !== l) ||
                  s.style.setProperty(
                    `--${a}-bottom`,
                    Math.max(0, Math.min(e, o)) + "px"
                  ));
            }),
