...
@section('footer_scripts')
 ...
 @include('admin.common.datatables', array('route'=>'/exams/student/quiz/getList/'.$category->slug, 'route_as_url' => TRUE))
 @include('admin.common.deletescript', array('route'=>'/exams/quiz/delete/'))
