		...
		<!-- Page Heading -->
				...
				<div class="panel panel-custom" style="margin-top: 40px; min-height: 700px;">
					<div class="panel-heading">
						<h1>THÔNG BÁO<?php //change_furigana_text ($title); ?></h1></div>
						<div class="panel-body">
							<div class="profile-details text-center">
								<!-- <div style="padding-bottom: 30px;"><img src="https://elearning.hikariacademy.edu.vn/public/uploads/settings/logo-elearning.png" alt="logo" class="cs-logo" style="width: 140px;"></div>
							...
							<div class="panel-body" style="padding-bottom: 60px;">
								<div class="row">
									<div class="col-sm-12">
										...
										?>
										<div class="alert alert-success" id="exam-alert-success" role="alert" style="width: 700px; margin: 0 auto; padding: 30px 0px"><h3 style="text-align: center; color: #185181;">Bạn đã thi xong phần thi <?php echo $title; ?></h3></div>
									</div>
								</div>
								<br/>
								<div class="row" id="btt_continue">
									<div class="col-lg-12 text-lef6">
										<?php if ($finish == 1) { ?>
														...
														<fieldset class='form-group'>
															...
															<div class="form-group row">
																...
																<div class="col-md-2">
																	...
																	<label for="giaodien2"> <span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i> </span>Hơi khó nhìn </label>
																</div>
																<div class="col-md-2">
														...
														<fieldset class='form-group'>
															...
															<div class="form-group row">
																...
																<div class="col-md-2">
																	...
																	<label for="thaotac2"> <span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i> </span>Hơi khó</label>
																</div>
																<div class="col-md-2">
											...
											<div class="panel panel-info panel-ketqua" style="width: 700px; margin: 0 auto; display: none" id="panel-ketqua">
												<div class="panel-heading" style="padding: 6px 15px;">
												...
												<div class="panel-body" style="padding: 30px">
													...
													<table class="table table-bordered" style="width: 100%;" id="table-result">
													  ...
													  <tbody>
													    <tr>
													      <td><span class="label label-<?php echo $quiz_1_total; ?>"><?php echo $record_resultfinish->quiz_1_total; ?>/<?php echo $percent_mark; ?></span></td>
													      <?php if($examseries_category <= 3) {?>
													      <td><span class="label label-<?php echo $quiz_2_total; ?>"><?php echo $record_resultfinish->quiz_2_total; ?>/60</span></td>
													      <?php } ?>
													      <td><span class="label label-<?php echo $quiz_3_total; ?>"><?php echo $record_resultfinish->quiz_3_total; ?>/60</span></td>
													      <td><span class="label label-<?php echo $detail; ?>"><?php echo $record_resultfinish->total_marks; ?>/180</span></td>
									...
									<div style="padding-top: 40px;">
										<div class="col-lg-12 text-center" id="thitiep" <?php if ($finish == 1) {echo 'style="display:none"';} ?>>
											<?php if ($finish == 1) {
											...
											<a href="<?php echo $redirect_url; ?>" class="btn t btn-primary" style=""><?php echo $thitiep; ?></a>
