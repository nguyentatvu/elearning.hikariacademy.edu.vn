@include('admin.emails.template_header')
 ...
 <div class="row">
   ...
   <div class="row">
	...
	<p style="font-size:20px;margin:11px 0;">Thank you for your registration with OES.</p>
  <p style="font-size:20px;margin:11px 0;">You can login with the below details</p>
