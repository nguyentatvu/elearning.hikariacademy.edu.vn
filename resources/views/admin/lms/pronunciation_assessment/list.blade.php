            ...
            <div class="panel panel-custom">
                <div class="panel-heading">
                    <div class="pull-right messages-buttons">
                        <a class="btn btn-primary button" href="/lms/pronunciation-assessment/add">
                            Thêm mới
                        </a>
                    </div>
                    <h1>
...
@section('footer_scripts')
    ...
    @include('admin.common.datatables', [
        'route' => route('lms.pronunciation_assessment.list'),
        'route_as_url' => 'TRUE',
        'table_columns' => $defaultColumns,
    ])
    @include('admin.common.deletescript', ['route' => '/lms/pronunciation-assessment/delete/'])
@stop
</link>
