            ...
            <div class="panel panel-custom">
                            ...
                            <div class="col-sm-6">
                                <div class="media state-media box-ws">
                                    <div class="media-body">
                                        ...
                                        <p>Thời điểm login gần nhất của học viên: <span
                                                class="text-primary">{{ $record->updated_at }}</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="media state-media box-ws h-100">
                                    <div class="media-body">
                                        <p>Bài học sau cùng học viên đã học: <span
                                                class="text-primary">{{ $last_lesson }}</span></p>
                                    </div>
                                </div>
                                <div class="media state-media box-ws">
                                    <div class="media-body">
                                        ...
                                        <p>Thời điểm gần nhất học viên tiến hành làm bài tập: <span
                                        ...
                                        @php
                                            $lastExam = $mock_exam_results->count() > 0 ? $mock_exam_results->first()->created_at : "Chưa tham gia";
                                        @endphp
               ...
               <div class="col-md-6" style="display: none;">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" id="exportSingle"
                                    data-type="single">{{ $record->name }}</button>
                ...
                <div class="modal fade" id="formatModal" tabindex="-1" role="dialog"
                    aria-labelledby="formatModalTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
