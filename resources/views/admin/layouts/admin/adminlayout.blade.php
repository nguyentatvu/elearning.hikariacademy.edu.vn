...
<body ng-app="academia">
    ...
    <div id="wrapper" class="{{ $class }}">
        <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ URL_HOME }}" target="_blank"><img
                        src="/public/uploads/settings/logo-elearning.png" style="width: 150px;"></a>
            </div>
            ...
            <ul class="nav navbar-right top-nav">
                <li class="dropdown profile-menu">
                    <div class="dropdown-toggle top-profile-menu" data-toggle="dropdown">
                        ...
                        @endif
                        <div class="profile-img"> <img src="{{ getProfilePath(Auth::user()->image, 'thumb') }}"
                                alt=""> </div>
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li {{ isActive($active_class, 'exams') }}>
                        ...
                        <ul id="exams" class="collapse sidemenu-dropdown">
                            <li><a href="{{ URL_EXAM_SERIES }}"> <i class="fa fa-fw fa-certificate"></i> Bộ đề thi</a>
                            </li>
                            <li><a href="{{ URL_QUIZ_QUESTIONBANK }}"> <i class="fa fa-fw fa-fw fa-question"></i>Ngân
                                    hàng câu hỏi</a></li>
                            ...
                            <li><a href="{{ URL_MASTERSETTINGS_TOPICS }}"> <i class="fa fa-fw fa-database"></i> Câu hỏi
                                    mondai</a></li>
                            <li><a href="{{ URL_BOOKS }}"> <i class="fa fa-fw fa-book"></i> Sách</a></li>
                            <li><a href="{{ URL_QUIZ_CATEGORIES }}"> <i class="fa fa-fw fa-fw fa-random"></i>Danh mục
                                    đề</a></li>
                            <li><a href="{{ URL_INSTRUCTIONS }}"> <i class="fa fa-fw fa-hand-o-right"></i>Hướng
                                    dẫn</a></li>
                        </ul>
                    </li>
                    <li {{ isActive($active_class, 'articles') }}>
                        <a data-toggle="collapse" data-target="#article"><i class="fa fa-fw fa-newspaper-o"></i> Bài
                            viết</a>
                        <ul id="lms" class="collapse sidemenu-dropdown">
                            <li><a href="{{ route('articles.articles.index') }}"><i class="fa fa-fw fa-list"></i>Danh
                                    sách sách bài viết</a></li>
                            <li><a href="{{ route('articles.categories.index') }}"> <i
                                        class="fa fa-fw fa-sliders"></i>Quản lý chuyên mục</a></li>
                        </ul>
                    </li>
                    ...
                    <li {{ isActive($active_class, 'dotthi') }}>
                        <a data-toggle="collapse" data-target="#dotthi"><i class="fa fa-fw fa-book"></i>Đợt thi
                            thử</a>
                        <ul id="lms" class="collapse sidemenu-dropdown">
                            <li><a href="{{ URL_EXAM_SERIES_FREE }}"> <i class="fa fa-fw fa-list"></i>Danh sách đợt
                                    thi</a></li>
                            <li><a href="{{ URL_EXAM_SERIES_FREE_ADD }}"> <i class="fa fa-fw fa-plus"></i>Thêm
                                    mới</a></li>
                        </ul>
                    </li>
                    <li {{ isActive($active_class, 'khoahoc') }}>
                        ...
                        <ul id="lms" class="collapse sidemenu-dropdown">
                            <li><a href="{{ URL_LMS_SERIES }}"> <i class="fa fa-fw fa-list"></i>Danh sách khóa
                                    học</a></li>
                    ...
                    <li {{ isActive($active_class, 'khoaluyenthi') }}>
                        <a data-toggle="collapse" data-target="#khoaluyenthi"><i class="fa fa-fw fa-certificate"></i>
                            Khóa luyện thi </a>
                        <ul id="lms" class="collapse sidemenu-dropdown">
                            <li><a href="{{ URL_LMS_SERIES_EXAM }}"> <i class="fa fa-fw fa-list"></i>Danh sách
                                    KLT</a></li>
                            <li><a href="/lms/seriessexam/add"> <i class="fa fa-fw fa-plus"></i>Thêm mới</a></li>
                        </ul>
                    </li>
                    <li {{ isActive($active_class, 'chiphikhoahoc') }}>
                        <a data-toggle="collapse" data-target="#chiphikhoahoc"><i
                                class="fa fa-fw fa-shopping-cart"></i>Đăng Khóa học </a>
                        <ul id="lms" class="collapse sidemenu-dropdown">
                            <li><a href="{{ PREFIX . 'lms/seriescombo' }}"> <i class="fa fa-fw fa-list"></i>Danh sách
                                    đăng</a></li>
                            <li><a href="{{ PREFIX . 'lms/seriescombo/add' }}"> <i class="fa fa-fw fa-plus"></i>Thêm
                                    mới</a></li>

                        </ul>
                    </li>
                    <li {{ isActive($active_class, 'roadmap') }}>
                        <a data-toggle="collapse" data-target="#roadmap"><i class="mdi mdi-map"></i>Quản lý lộ
                            trình</a>
                        <ul id="lms" class="collapse sidemenu-dropdown">
                            <li><a href="{{ route('roadmap.list') }}"> <i
                                        class="mdi mdi-format-list-bulleted"></i>Danh sách lộ trình của khoá học</a>
                            </li>
                        </ul>
                    </li>
                    <li {{ isActive($active_class, 'handwriting') }}>
                        <a data-toggle="collapse" data-target="#handwriting"><i class="fa fa-fw fa-pencil"></i>Luyện
                            viết</a>
                        <ul id="handwriting" class="collapse sidemenu-dropdown">
                            <li><a href="/lms/handwriting"> <i class="fa fa-fw fa-list"></i>Danh sách Luyện viết</a>
                            </li>
                            <li><a href="/lms/handwriting/add"> <i class="fa fa-fw fa-plus"></i>Thêm mới</a></li>
                        </ul>
                    </li>
                    <li {{ isActive($active_class, 'coupons') }}>
                        <a data-toggle="collapse" data-target="#coupons"><i
                                class="fa fa-fw fa-tags"></i>Flashcard</a>
                    ...
                    <li {{ isActive($active_class, 'pronunciation-assessment') }}>
                        <a data-toggle="collapse" data-target="#coupons"><i class="fa fa-fw fa-microphone"></i>Luyện
                            phát âm</a>
                        <ul id="coupons" class="collapse sidemenu-dropdown">
                            <li><a href="/lms/pronunciation-assessment"> <i class="fa fa-fw fa-list"></i>Danh sách bài
                                    Luyện phát âm</a></li>
                            <li><a href="/lms/pronunciation-assessment/add"> <i class="fa fa-fw fa-plus"></i>Thêm
                                    mới</a></li>
                        </ul>
                    </li>
                    <li {{ isActive($active_class, 'reports') }}>
                        <a data-toggle="collapse" data-target="#reports"><i class="fa fa-fw fa-credit-card"></i> Báo
                            cáo thanh toán </a>
                        <ul id="reports" class="collapse sidemenu-dropdown">
                            <li><a href="{{ PREFIX . 'payments-order' }}"> <i class="fa fa-fw fa-shopping-cart"></i>Đơn
                                    hàng mua khoá học</a></li>
                            <li><a href="{{ route('payments.order.coin') }}"> <i class="fa fa-star"></i>Đơn hàng nạp
                                    Hi coin</a></li>
                            <li><a href="/payments-report/online/success"> <i class="fa fa-fw fa-link"></i>Thanh toán
                                    Online</a></li>
                            <li><a href="{{ route('payments-order.coin-recharge-packages.index') }}"> <i
                                        class="mdi mdi-coin"></i>Quản lý các gói nạp HiCoin</a></li>
                        </ul>
                    </li>
                    <li {{ isActive($active_class, 'point-management') }}>
                        <a data-toggle="collapse" data-target="#point_management"><i class="mdi mdi-coin"></i> Quản
                            lý điểm tích luỹ </a>
                        <ul id="point_management" class="collapse sidemenu-dropdown">
                            <li><a href="{{ route('point-management.list') }}"> <i class="mdi mdi-coin"></i>Danh sách
                                    những loại điểm tích luỹ</a></li>
                        </ul>
                    </li>
                    ...
                    <li {{ isActive($active_class, 'messages') }}>
                        <a href="{{ PREFIX . 'comments/index' }}"> <i class="fa fa-fw fa-comments" aria-hidden="true">
                            </i>
                            Comment <small class="msg">{{ $count = Auth::user()->newThreadsCount() }} </small></a>
                    </li>
                    <li {{ isActive($active_class, 'khoahoc') }}>
                        <a data-toggle="collapse" data-target="#khoahoc"><i class="fa fa-user fa-user"></i> Lớp học
                            chỉ định </a>
                        <ul id="lms" class="collapse sidemenu-dropdown">
                            <li><a href="{{ PREFIX . 'lms/class-content/' }}"> <i class="fa fa-fw fa-list"></i>Danh
                                    sách lớp</a></li>
                            <li><a href="/lms/class-content/add"> <i class="fa fa-fw fa-plus"></i>Thêm khóa học</a>
                            </li>
                        </ul>
                    </li>
                    <li {{ isActive($active_class, 'class') }}> <a href="{{ URL_CLASS }}"><i
                                class="fa fa-fw fa-users"></i> Lớp học </a> </li>
                    <li {{ isActive($active_class, 'users') }}> <a href="{{ URL_USERS }}"><i
                                class="fa fa-fw fa-user-circle"></i> {{ getPhrase('users') }} </a> </li>
                    <li {{ isActive($active_class, 'master_settings') }}>
                        <a data-toggle="collapse" data-target="#master_settings" href="#"><i
                        ...
                        <ul id="master_settings" class="collapse sidemenu-dropdown">
                            ...
                            @if (checkRole(getUserGrade(1)))
                                ...
                                <li><a href="maintenance/removefiles"> <i class="icon-settings"></i> Dọn dẹp
                                        Content</a></li>
                            @endif
                        </ul>
                    </li>
        ...
        @if (isset($right_bar))
            <aside class="right-sidebar" id="rightSidebar">
                <button class="sidebat-toggle" id="sidebarToggle" href='javascript:'><i
                ...
                <div class="panel panel-right-sidebar">
                    ...
                    ?>
                    @include($right_bar_path, ['data' => $data])
                </div>
            </aside>
        @endif
        @yield('content')
    ...
    <div class="ajax-loader" style="display:none;" id="ajax_loader"><img src="{{ AJAXLOADER }}">
        {{ getPhrase('please_wait') }}...</div>
</body>
