					...
					<div class="col-md-3">
						<div class="card card-green text-xs-center">
							<div class="card-block">
								...
								<p class="card-text">{{ getPhrase('subscribed_users')}}</p>
							</div>
							<a class="card-footer text-muted" href="{{URL_SUBSCRIBED_USERS}}">
								{{ getPhrase('view_all')}}
							</a>
						</div>
					</div>
...
@section('footer_scripts')
 ...
 @include('admin.common.chart', array('chart_data'=>$payments_chart_data,'ids' =>array('payments_chart'), 'scale'=>TRUE))
 @include('admin.common.chart', array('chart_data'=>$payments_monthly_data,'ids' =>array('payments_monthly_chart'), 'scale'=>true))
 @include('admin.common.chart', array('chart_data'=>$demanding_quizzes,'ids' =>array('demanding_quizzes')))
 @include('admin.common.chart', array('chart_data'=>$demanding_paid_quizzes,'ids' =>array('demanding_paid_quizzes')))
