...
@section('footer_scripts')
 ...
 @include('admin.common.datatables', array('route'=>URL_COUPONS_USAGE_AJAXDATA, 'route_as_url' => TRUE))
 @include('admin.common.deletescript', array('route'=>URL_COUPONS_DELETE))
