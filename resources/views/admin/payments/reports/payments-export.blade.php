...
<div id="page-wrapper" ng-controller="payments_report" ng-init="initAngData()">
				...
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li class="active">Báo cáo thanh toán</li>
 ...
 <h1>Xuất file báo cáo thanh toán </h1>

					</div>

					<div class="panel-body" >

					<?php $button_name = 'Xuất file excel'; 
					...
					<fieldset class='form-group'>
						...
						<div class="col-md-3">
							...
							{{ Form::radio('all_records', 1, true, array('id'=>'paid', 'name'=>'all_records', 'ng-model'=>'all_records')) }}
								...
								<label for="paid"> <span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i> </span> Có </label>
							...
							{{ Form::radio('all_records', 0, false, array('id'=>'free', 'name'=>'all_records', 'ng-model'=>'all_records')) }}
								...
								<label for="free"> <span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i> </span> Không</label> 
  				 ...
  				 <fieldset class="form-group col-md-3">
					...
					<div class="row">
					 ...
					 <fieldset class='form-group'>
						...
						{{ Form::label('payment_type', 'Loại thanh toán') }}
						...
						<div class="form-group row">
							...
							{{ Form::radio('payment_type', 'all', true, array('id'=>'free1', 'name'=>'payment_type')) }}
								...
								<label for="free1"> <span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i> </span> Tất cả</label> 
							...
							{{ Form::radio('payment_type', 'online', false, array('id'=>'paid1', 'name'=>'payment_type')) }}
								...
								<label for="paid1"> <span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i> </span> Online </label>
							...
							{{ Form::radio('payment_type', 'offline', false, array('id'=>'offline', 'name'=>'payment_type')) }}
								...
								<label for="offline"> <span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i> </span> Offline </label>
					...
					<div class="row">
					 ...
					 <fieldset class='form-group'>
						...
						{{ Form::label('payment_status', 'Tình trạng') }}
						...
						<div class="form-group row">
							...
							{{ Form::radio('payment_status', 'all', true, array('id'=>'payment_status_all', 'name'=>'payment_status')) }}
								...
								<label for="payment_status_all"> <span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i> </span> Tất cả</label> 
							...
							{{ Form::radio('payment_status', 'success', false, array('id'=>'payment_status_success', 'name'=>'payment_status')) }}
								...
								<label for="payment_status_success"> <span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i> </span> Thành công</label>
							...
							{{ Form::radio('payment_status', 'cancelled', false, array('id'=>'payment_status_cancelled', 'name'=>'payment_status')) }}
								...
								<label for="payment_status_cancelled"> <span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i> </span> Hủy </label>
