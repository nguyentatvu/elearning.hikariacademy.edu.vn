    <div class="sidebar d-flex flex-sm-column flex-row flex-nowrap align-items-center sticky-top">
        <ul
            ...
            <li class="sidebar-item active nav-item">
                <a href="#" class="nav-link d-flex flex-column justify-content-center align-items-center w-100" title="" data-bs-toggle="tooltip"
                    ...
                    <img src="{{ asset('images/icons/Home.jpg') }}" alt="" srcset="">
                    <span>Trang chủ</span>
                </a>
            </li>
            <li class="sidebar-item nav-item">
                <a href="#" class="nav-link d-flex flex-column justify-content-center align-items-center w-100" title="" data-bs-toggle="tooltip"
                    ...
                    <img src="{{ asset('images/icons/Roadmap.jpg') }}" alt="" srcset="">
                    <span>Lộ trình</span>
                </a>
            </li>
            <li class="sidebar-item nav-item">
            ...
            <li class="sidebar-item nav-item">
                <a href="#" class="nav-link d-flex flex-column justify-content-center align-items-center w-100" title="" data-bs-toggle="tooltip"
                    ...
                    <img src="{{ asset('images/icons/Contact.png') }}" alt="" srcset="">
                    <span>Liên hệ</span>
                </a>
            </li>
            <li class="sidebar-item nav-item">
                <a href="#" class="nav-link d-flex flex-column justify-content-center align-items-center w-100" title="" data-bs-toggle="tooltip"
                    data-bs-placement="right" data-bs-original-title="Products">
                    <img src="{{ asset('images/icons/Message-Bot.png') }}" alt="" srcset="">
                    <span>Chat</span>
                </a>
            </li>
        </ul>
