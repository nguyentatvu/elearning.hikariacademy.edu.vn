	...
	<div class="row">
		<div class="panel panel-custom" style="position: relative;">
			...
			<div class="panel-body" >
				<div class="col-xs-4 cl1" id="question-palette1">
					<h3 class="text-primary">
						...
						if ($quiz->type == 1) { ?>
							...
							@include('client.mock-exam.components.exam-form-mp3', array($questions))
						<?php }	?>

					</h3>

					<div class="answers-page-pagination question-palette">
						@include('client.mock-exam.components.exam-leftbar-subjects', array('subjects' => $subjects))
					</div>
				</div>
				<?php
				$finish = '';
				...
				<div class="col-xs-4 cl3 mul-choice-section">
					<div class="question-palette hikari-h130" id="question-palette">
						...
						@if ($quiz->category_id == 1)
							...
							<table class="table table-bordered hikari-table-answer" style="width: 60%;">
								<!-- Cau tra loi -->
								{!! Form::open(array('url' => route('mock-exam.finish-exam', $quiz->slug), 'method' => 'POST', 'id'=>'onlineexamform')) !!}
