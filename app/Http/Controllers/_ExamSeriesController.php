...
class ExamSeriesController extends Controller
{
    ...
    public function index()
    {
      ...
      // return view('exams.examseries.list', $data);
       $view_name = 'admin.exams.examseries.list';
    ...
    public function getDatatable()
    {
      if(!checkRole(getUserGrade(2)))
      {
        ...
        $records = array();
            $records = ExamSeries::select(['title', 'image', 'is_paid', 'cost', 'total_exams','total_questions','slug', 'id', 'updated_at'])
        ...
        ->addColumn('action', function ($records) {
          $link_data = '<div class="dropdown more">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dLabel">
                           <li><a href="'.URL_EXAM_SERIES_UPDATE_SERIES.$records->slug.'"><i class="fa fa-spinner"></i>Cập nhật đề thi</a></li>
    ...
    public function create()
    {
      ...
      // return view('exams.examseries.add-edit', $data);
        $view_name = 'admin.exams.examseries.add-edit';
        return view($view_name, $data);
    }
    /**
    ...
    public function listSeries()
    {
      if(checkRole(getUserGrade(2)))
      {
        ...
        $interested_categories = (object)array('quiz_categories' =>   
                                                  array ( 0 => 1,
                                                          1 => 3,
                                                          2 => 4,
                                                          3 => 5,
        ...
        */
        ...
        if (count($classes_user)>0) {
          ...
          $classes_exam =  ExamSeries::join('classes_exam', 'classes_exam.exam_id', '=', 'examseries.id')
                       ...
                       ->where('classes_exam.start_date','<=',date('Y-m-d'))
                       ->where('classes_exam.end_date','>=',date('Y-m-d'))
                       ->get();
