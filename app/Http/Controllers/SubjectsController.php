...
class SubjectsController extends Controller
{
  ...
  public function __construct()
  {
    ...
    public function index()
    {
      ...
      $data['title']              = 'Danh sách Mondai';
      // return view('mastersettings.subjects.list', $data);
      $view_name = 'admin.mastersettings.subjects.list';
    ...
    public function getDatatable()
    {
      ...
      ->rawColumns(['action', 'subject_code'])
      ->make();
    }
    /**
    ...
    public function create()
    {
      ...
      $view_name = 'admin.mastersettings.subjects.add-edit';
      return view($view_name, $data);
    }
    /**
  ...
  return json_encode($response);
    ...
    */
    public function import()
    {
      ...
      $view_name = 'admin.mastersettings.subjects.import.import';
      return view($view_name, $data);
    }
...
$view_name = 'admin.mastersettings.subjects.import.import-result';
return view($view_name, $data);
}
