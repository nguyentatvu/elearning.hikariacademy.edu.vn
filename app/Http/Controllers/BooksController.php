...
class BooksController extends Controller
{
  public function __construct()
  {
    ...
    public function index()
    {
        ...
        $data['active_class']       = 'book';
        $data['title']              = 'Sách';
        $view_name = 'admin.books.list';
    ...
    public function getDatatable()
    {
        ...
        ->addColumn('action', function ($records) {
                     ...
                     <li><a href="'.$records->id.'"><i class="fa fa-pencil"></i>'.getPhrase("edit").'</a></li>';
                     $temp = '';
    ...
    public function create()
    {
        ...
        $data['title']              = 'Thêm sách';
        $view_name = 'admin.books.add-edit';
        return view($view_name, $data);
  }
    /**
    ...
    $view_name = 'admin.exams.quizcategories.add-edit';
    return view($view_name, $data);
}
    /**
