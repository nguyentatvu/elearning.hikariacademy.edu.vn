  ...
  public $columns = '';
   public function __construct()
    ...
    public function create()
    {
      ...
      $view_name = 'admin.classes.add-edit-classes';
      return view($view_name, $data);
    }
    /**
...
public function downloadExcel()
{
  ...
  public function viewClassesDetails($slug)
  {
     if(!checkRole(getUserGrade(4)))
      ...
      $view_name = 'admin.classes.classes-details';
      return view($view_name, $data);
  }
  ...
  public function updateClassesDetails(Request $request, $slug)
  {
        ...
        DB::beginTransaction();
            ...
            DB::table('users')->where('id','=',$request->parent_user_id)
                              ->update(['is_hocvien' => 1])
                  ;
        try{
            $classes_user->save();
