...
class NativeController extends Controller
{
    ...
    public function index()
    {
    	if(!checkRole(getUserGrade(2)))
      {
        ...
        // return view('languages.list', $data);
          ...
          $view_name = 'admin.languages.list';
    ...
    public function getDatatable()
    {
    	if(!checkRole(getUserGrade(2)))
      {
        ...
        ->removeColumn('id')
        ->removeColumn('slug')
        ->rawColumns(['action','language','is_rtl','is_default'])
        ->make();
    }
    /**
    ...
    public function create()
    {
     if(!checkRole(getUserGrade(2)))
      ...
      $view_name = 'admin.languages.add-edit';
        return view($view_name, $data);
    }
    ...
    public function updateLanguageStrings($slug)
    {
        if(!checkRole(getUserGrade(2)))
      {
        ...
        // return view('languages.sub-list', $data);
          ...
          $view_name = 'admin.languages.sub-list';
        return view($view_name, $data);
    }
