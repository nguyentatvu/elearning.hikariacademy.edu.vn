...
class QuizController extends Controller
{
  ...
  public function getExamSettings()
  {
    ...
    public function index()
    {
      ...
      $view_name = 'admin.exams.quiz.list';
    ...
    public function getDatatable($slug = '')
    {
      ...
      {
        return '<a href="'.URL_QUIZ_UPDATE_QUESTIONS.$records->slug.'">'.change_furigana_admin($records->title).'</a>';
      })
    ...
    public function create()
    {
      ...
      // dd($data);
      $data['title']              = 'Tạo mới đề thi';
      // return view('exams.quiz.add-edit', $data);
      $view_name = 'admin.exams.quiz.add-edit';
      return view($view_name, $data);
    }
    /**
   ...
   return redirect(URL_QUIZZES);
    ...
    public function getSubjectData(Request $request)
    {
      ...
      ->get();
      $questions = $subject->questions()->join('topics','topics.id','=','questionbank.topic_id')->get(['questionbank.id', 'questionbank.subject_id', 'topics.topic_name','topic_id', 'question_type', 'question', 'book', 'page', 'marks', 'correct_answers','difficulty_level', 'questionbank.status']);
  ...
  $view_name = 'admin.exams.quiz.update-questions';
  return view($view_name, $data);
}
 ...
 return redirect(URL_QUIZZES);
     ...
     */
     public function examTypes()
     {
      ...
      $view_name = 'admin.exams.exam-types';
      return view($view_name, $data);
    }
    ...
    $view_name = 'admin.exams.edit-exam-type';
    return view($view_name, $data);
  }
