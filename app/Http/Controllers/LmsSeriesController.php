...
class LmsSeriesController extends Controller
{
	...
	public function listCategories(){
        ...
        $data['series'] = DB::table('lmsseries_combo')
            ...
            ->select('lmsseries.*',DB::raw("(lmsseries_combo.slug) as combo_slug"),'lmsseries_combo.image as combo_image','payments.time','payment_method.created_at','payment_method.status','payment_method.month_extend',
	...
	public function getSeriesOverviewContent(Request $request){
		...
		$url = route('learning-management.lesson.show',
