...
define('FRONT_ASSETS', PREFIX.'front/');
...
define('URL_QUIZ_TOPIC_GET_QUESTIONS', PREFIX.'exams/quiz/topic-get-questions');
...
define('URL_QUESTIONBANK_AJAX_FURIGANA', PREFIX.'exams/ajax_furigana');

define('URL_QUESTIONBAMK_IMPORT', PREFIX.'exams/questionbank/import');


//FLASHCARD MODULE
define('URL_FLASHCARD_LIST', PREFIX.'lms/flashcard');
...
//CONSTANST FOR ClASS MODULE

define('URL_CLASS', PREFIX.'classes');

define('URL_CLASS_DETAILS', PREFIX.'class/details/');

define('URL_CLASS_EDIT', PREFIX.'class/edit/');

define('URL_CLASS_ADD', PREFIX.'class/create');

define('URL_CLASS_DELETE', PREFIX.'class/delete/');
...
// Define route user details learning
define('URL_USER_DETAILS_LEARNING', PREFIX.'users/details-learning/');
...
define('URL_STUDENT_EXAM_ATTEMPTS_FINISH', PREFIX.'exams/student/exam-attempts-finish/');
...
define('URL_STUDENT_EXAM_GETATTEMPTS_FINISH', PREFIX.'exams/student/get-exam-attempts-finish/');
...
define('URL_START_EXAM', PREFIX.'exams/check/start-exam/');
...
define('URL_PARENT_CLASS_GETLIST', PREFIX.'parent/class/getList/');

define('URL_SUBSCRIBE', PREFIX.'subscription/subscribe/');

define('URL_PARENT_CLASS', PREFIX.'parent/class');

define('URL_PARENT_EXAM_LIST', PREFIX.'parent/exam_list/');

define('URL_PARENT_EXAM_GETLIST', PREFIX.'parent/exam/getList/');

define('URL_PARENT_CLASSMARK_GETLIST', PREFIX.'parent/getclassmark/');

define('URL_PARENT_CLASS_DELETE', PREFIX.'parent/delete/');
...
define('URL_EXAM_SERIES_CHECK_EXAMS', PREFIX.'exams/exam-series/check-exams/');
...
define('URL_EXAM_SERIES_FREE', PREFIX.'exams/exam-series-free');

define('URL_EXAM_SERIES_FREE_ADD', PREFIX.'exams/exam-series-free/add');

define('URL_EXAM_SERIES_FREE_DELETE', PREFIX.'exams/exam-series-free/delete/');

define('URL_EXAM_SERIES_FREE_EDIT', PREFIX.'exams/exam-series-free/edit/');

define('URL_EXAM_SERIES_FREE_AJAXLIST', PREFIX.'exams/exam-series-free/getList');

define('URL_EXAM_SERIES_FREE_UPDATE_SERIES', PREFIX.'exams/exam-series-free/update-series/');

define('URL_EXAM_SERIES_FREE_GET_EXAMS', PREFIX.'exams/exam-series-free/get-exams');

define('URL_EXAM_SERIES_FREE_CHECK_EXAMS', PREFIX.'exams/exam-series-free/check-exams/');

define('URL_EXAM_SERIES_RATE_SERIES', PREFIX.'exams/exam-series-free/rate/');

define('URL_EXAM_SERIES_RATE_AJAXLIST', PREFIX.'exams/exam-series-free/getrateList/');

define('URL_EXAM_SERIES_RATE_RESULT_AJAXLIST', PREFIX.'exams/exam-series-free/getrateresultList/');
...
define('URL_AJAX_PAYMENTS_CHECKOUT', PREFIX.'payments/ajaxcheckout');
...
define('URL_LMS_SERIES_EXAM', PREFIX.'lms/seriesexam');
...
define('URL_OFFLINE_PAYMENT_REPORT_DETAILS', PREFIX.'payments-report/add-offline');
...
define('URL_CLASESS_CLASS_GETLIST', PREFIX.'classes/getList');

define('URL_CLASSES_DELETE', PREFIX.'classes/delete/');

define('URL_CLASSES_ADD', PREFIX.'classes/add');

define('URL_SEARCH_USERCLASSES_RECORDS', PREFIX.'classes/search/user');

define('URL_CLASSES_USER_GETLIST', PREFIX.'classes/user/getList/');

define('URL_CLASSES_USER_DELETE', PREFIX.'classes/user/delete/');



define('AJAX_LOG_NGHE', PREFIX.'exams/student/ajax_log');

//Books

define('URL_BOOKS', PREFIX.'books');
define('URL_BOOKS_GETLIST', PREFIX.'books/getList');
define('URL_BOOKS_DELETE', PREFIX.'books/delete/');
define('URL_BOOKS_ADD', PREFIX.'books/add');
define('URL_BOOKS_EDIT', PREFIX.'books/edit');

// CHART
define('URL_GET_CHART_DATA', PREFIX.'chart-data');

define('URL_GET_STUDENT_CHART_DATA', PREFIX.'chart/number-of-students');

// NUMBER OF STUDENTS ON THE LEADERBOARD
define('NUMBER_OF_STUDENTS_ON_THE_LEADERBOARD', 10);

// DAY OF WEEK
define('MONDAY', 1);

// PAGE LIMIT ITEMS SIZE
define('PAGE_ITEMS_LIMIT', 20);